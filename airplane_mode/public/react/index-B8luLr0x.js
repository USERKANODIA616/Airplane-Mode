...
` +
		...
		function kt(e) {
			var t = e[Ct];
			return (
				(t ||= e[Ct] = { hoistableStyles: new Map(), hoistableScripts: new Map() }),
				t
			);
		}
		function O(e) {
		...
		function Si(e, t, n, r, a, o) {
			...
			if (((r = e), typeof e == `function`)) yi(e) && (s = 1);
				...
				a: switch (e) {
					case ae:
						return ((e = vi(31, n, t, a)), (e.elementType = ae), (e.lanes = o), e);
					case y:
					...
					case b:
						...
						break;
					case x:
						return ((e = vi(12, n, t, a | 2)), (e.elementType = x), (e.lanes = o), e);
					case ne:
						return ((e = vi(13, n, t, a)), (e.elementType = ne), (e.lanes = o), e);
					case re:
						return ((e = vi(19, n, t, a)), (e.elementType = re), (e.lanes = o), e);
					default:
		...
		function Ec(e, t, n) {
			...
			if (
				((s = o) ||
					(s = e !== null && e.memoizedState === null ? !1 : (N.current & 2) != 0),
				s && ((a = !0), (t.flags &= -129)),
				(s = (t.flags & 32) != 0),
				(t.flags &= -33),
				e === null)
		...
		function fl(e, t, n) {
			...
			switch (n.tag) {
				...
				case 6:
					if (
						((r = U), (i = ul), (U = null), dl(e, t, n), (U = r), (ul = i), U !== null)
					)
						if (ul)
							try {
								(U.nodeType === 9
		...
		function yl(e, t) {
			...
			switch (e.tag) {
				...
				case 26:
					var a = vl;
					if (
						(_l(t, e), bl(e), r & 512 && (V || n === null || Xc(n, n.return)), r & 4)
					) {
				...
				case 22:
					...
					var l = n !== null && n.memoizedState !== null,
						...
						d = V;
					if (
						((il = u || a), (V = d || l), _l(t, e), (V = d), (il = u), bl(e), r & 8192)
					)
						a: for (
							t = e.stateNode,
					...
					r & 4 &&
						((r = e.updateQueue),
						r !== null &&
							((n = r.retryQueue), n !== null && ((r.retryQueue = null), gl(e, n))));
					break;
				case 19:
					(_l(t, e),
						bl(e),
...
`,
	...
	b = c(u(), 1),
	x = v();
function ee({ seatData: e = [], dialog: t }) {
			...
			return (0, x.jsx)(
				`button`,
				{
					...
					style: {
						...
						borderRadius: `6px`,
						backgroundColor: a ? `#ff4d4f` : o ? `#1677ff` : `#fff`,
						color: a || o ? `#fff` : `#000`,
...
window.renderSeatSelector = (e, t, n) => {
	(console.log(`INSIDE RENDER`, e, t),
		y.createRoot(e).render((0, x.jsx)(ee, { seatData: t || [], dialog: n })));
};
